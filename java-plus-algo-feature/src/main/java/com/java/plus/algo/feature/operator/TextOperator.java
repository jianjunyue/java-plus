package com.java.plus.algo.feature.operator;
...
public class TextOperator implements Serializable {
     ...
     * @return
     */
    public double dayOfWeek(String date){
     ...
     * @return
     */
    public int hourOfDay(String date){
        SimpleDateFormat simpleDateFormat = getDateFormat(date);
        try{
     ...
     * @return
     */
    public double weekOfMonth(String date){
        SimpleDateFormat simpleDateFormat = getDateFormat(date);
        Calendar calendar = Calendar.getInstance();
        try{
            calendar.setTime(simpleDateFormat.parse(date));
     ...
     * @return
     */
    public double durationOfDate(String start, String end){
     ...
     * @return
     */
    public double[] toKeyWord(String document, List<String> keyWordList){
     ...
     * @return
     */
    public double[] toOneHot(String cate, List<String> cateList, double defaultValue) {
    ...
    public double[] toOneHot(String cate, List<String> cateList) {
     ...
     * @return
     */
    public double[] toOneHotOrder(String cate, List<String> cateList, double defaultValue) {
        int size = cateList.size();
    ...
    public double[] toOneHotOrder(String cate, List<String> cateList) {
     ...
     * @return
     */
    public double[] hiddenVector(String data, int n) {
    ...
    public double targetEncoder(String category, Map<String, Double> map, double defaultValue) {
        return map.getOrDefault(category, defaultValue);
    }

    public double[] categoryInter(int maxSize, Map<String, Integer> interMap, String delimit, String... field) {
    ...
    public double[] multiOneHot(String sentence, List<String> cateList, double defaultValue) {
    ...
    public double[] multiOneHot(String sentence, List<String> cateList) {
     ...
     * @return
     */
    public double[] categoryHashInter(int maxSize, String... field) {
     ...
     * @return
     */
    public double[] categoryHashEncode(String field, int hashSize) {
     ...
     * @return
     */
    public double extractFloat(String field, int loc) {
    ...
    public double[] hashCode(String field, int hashSize){
     ...
     * @return
     */
    public double[] map2Vector(String json, List<String> keyList) {
